    ...
    <div>
      <div className="share-info">
        <div className="image-wrap big user-page-header">
          <a className="user" href="user.html">
            <img
              className="suggestedAccountIcon user_photo"
              src={userInfo?.user?.avatarThumb}
            />
          </a>
        </div>
        <div className="share-title-container">
          <h3 className="share-title verified">
            {userInfo?.user?.nickname}
          </h3>
          <h6 className="share-sub-title">
          ...
          <div className="share-follow-container">
            <div className="follow-button-wrap button">
              <button
                type="button"
                className="btn btn-danger btn_new"
              >
                Підписатися
              </button>
            </div>
      ...
      <div className="popul_people">
        <div className="number">
          <h6 className="count-infos">
            <strong title="Подписки">
              {userInfo?.stats?.followingCount}
            </strong>
            <span className="unit">&nbsp;Підписки</span>
          </h6>
        </div>
        <div className="number">
          <h6 className="count-infos">
            <strong title="Подписчики">
              {userInfo?.stats?.followerCount}
            </strong>
            <span className="unit">&nbsp;Підписники</span>
          </h6>
        </div>
        <div className="number">
          <h6 className="count-infos">
            ...
            <span className="unit">&nbsp;Лайки</span>
          </h6>
        </div>
      </div>
