        ...
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="flex-fill">
            <div className="search_tikTok">
              <input type="text" className="search_tikTok_input form-control" placeholder="Пошук акаунтів та відео" />
          ...
          <div className="d-flex align-items-center">
            <a href="#" className="btn btn-default"><b>Завантажити</b></a>
            <div className="btn btn-danger"><b>Вхід</b></div>
